...
<body>
    ...
    <div class="d-flex justify-content-center">
        <div class="info-container mt-5" style="width: 790px;">
            ...
            <p class="mt-1">Laden Sie die gewünschte Information als .xml-Datei herunter und speichern Sie sie in einem Verzeichnis Ihrer Wahl oder im "Bibliography"-Ordner von Word. Um auf den "Bibliography"-Ordner zuzugreifen, drücken Sie "<svg style="padding-bottom: 4px;" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    <path d="M0 93.7l183.6-25.3v177.4H0V93.7zm0 324.6l183.6 25.3V268.4H0v149.9zm203.8 28L448 480V268.4H203.8v177.9zm0-380.6v180.1H448V32L203.8 65.7z" />
                </svg> + R" und geben Sie den Pfad ein.</p>
            <div class="combobox">
            ...
            <p class="mt-4">Öffnen Sie Word und klicken Sie auf die Registerkarte "Verweise".</p>
            <img src="../../assets/images/img/xml_step_1.jpeg" class="img-fluid rounded mb-3 xml_img" alt="...">
            <h2 class="fw-bold pt-2">3.</h2>
            <p class="mt-1">Klicken Sie auf "Quellen verwalten" im "Verweise"-Tab.</p>
            <img src="../../assets/images/img/xml_step_2.jpeg" class="img-fluid rounded mb-3 xml_img" alt="...">
            <h2 class="fw-bold pt-2">4.</h2>
            <p class="mt-1">Klicken Sie auf "Durchsuchen" im Fenster, das sich öffnet.</p>
            <img src="../../assets/images/img/xml_step_2.5.jpeg" class="img-fluid rounded mb-3 xml_img" alt="...">
            <h2 class="fw-bold pt-2">5.</h2>
            <p class="mt-1">Navigieren Sie zum Verzeichnis Ihrer .xml-Datei und wählen Sie diese aus.</p>
            <img src="../../assets/images/img/xml_step_3.jpeg" class="img-fluid rounded mb-3 xml_img" alt="...">
            <h2 class="fw-bold pt-2">6.</h2>
            <p class="mt-1">Wählen Sie die gewünschten Bücher aus der Liste aus und klicken Sie auf "Kopieren". Dann können Sie das Fenster schließen.</p>
            <img src="../../assets/images/img/xml_step_5.jpeg" class="img-fluid rounded mb-3 xml_img" alt="...">
            <h2 class="fw-bold pt-2">7.</h2>
            <p class="mt-1">Fügen Sie das Zitat ein, indem Sie im "Verweise"-Tab auf "Zitat einfügen" klicken und das gewünschte Buch auswählen.</p>
            <img src="../../assets/images/img/xml_step_6.jpeg" class="img-fluid rounded mb-3 xml_img" alt="...">
            <p class="mt-1">Sie können auch manuell Zitate und Bibliografien erstellen, indem Sie die richtigen Formate und Informationen verwenden. Verwenden Sie das Handbuch oder suchen Sie im Internet nach spezifischen Anweisungen. Wenn Sie Fragen haben, können Sie auch den Support von Word kontaktieren.</p>
        </div>
    </div>
