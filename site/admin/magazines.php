...
$statement = $conn->prepare("SELECT * FROM lib_magazines WHERE deleted = 0");
$statement->execute();
...
<body>
                ...
                ?>
                        <tr>
                            ...
                            <td class="table-align-center">
                                <div class="d-flex">
                                    <button type="button" class="btn border-0 d-inline" data-magazine='[&#34;<?php echo $row['magazine_title']; ?>&#34;, &#34;<?php echo $row['magazine_autor']; ?>&#34;, &#34;<?php echo $row['magazine_edition_j']; ?>&#34;, &#34;<?php echo $row['magazine_edition']; ?>&#34;, &#34;<?php echo $row['magazineID']; ?>&#34;, &#34;<?php echo $row['magazine_image']; ?>&#34;]' onclick="EditModal(this)">
                                    ...
                                    <a target="_blank" href='../services/controller/magazinepdf.php?ID=<?php echo $row['magazineID']; ?>' type="button" class="btn border-0 d-inline" data-id="<?php echo $row['magazineID']; ?>">
    ...
    <script type="text/javascript">
        ...
        function EditModal(entry) {
            ...
            document.getElementById("editCover").setAttribute('src', magazineArray[5]);

            console.log(magazineArray[5]);
