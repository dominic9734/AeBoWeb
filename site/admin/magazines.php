...
<body>
    ...
    <script type="text/javascript">
        ...
        function EditModal(entry) {
            ...
            $("#magazine_title").val(magazineArray[0]);
            $("#magazine_autor").val(magazineArray[1]);
            $("#magazine_edition_j").val(magazineArray[2]);
            $("#magazine_edition").val(magazineArray[3]);
            $("#magazineIDEdit").val(magazineArray[4]);
            $("#EditMagazineModal").modal("show");

            console.log($("#magazineIDEdit"));
        }
    </script>
</body>
