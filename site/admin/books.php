            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn border-0 editbtn" data-id="<?php echo $row['buchID']; ?>" data-bemerkung="<?php echo $row['book_comment']; ?>" data-kurzbeschrieb="<?php echo $row['book_aditionalinfo']; ?>" data-nummer="<?php echo $row['book_number']; ?>" data-titel="<?php echo $row['book_title']; ?>" data-autor="<?php echo $row['book_autor']; ?>" data-ausagbe="<?php echo $row['book_edition']; ?>" data-format_hardcover="<?php echo $row['format_hardcover']; ?>" data-format_pdf="<?php echo $row['format_pdf']; ?>" onclick="EditModal(this)">
                                ...
                                <td>
                                    <button type="button" class="btn border-0" data-id="<?php echo $row['buchID']; ?>" data-nummer="<?php echo $row['book_number']; ?>" onclick="DeleteModal(this)">
