...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="../../../assets/images/icons/logo_small.svg">
  ...
  <div id="outerContainer">
    ...
    <div id="dialogContainer">
      <dialog id="passwordDialog">
        <div class="row">
          <label for="password" id="passwordText" data-l10n-id="password_label">PDF Öffnen</label>
        </div>
        <div class="row">
          <input type="password" id="password" class="toolbarField hidden" value="123456">
        </div>
        <div class="buttonRow">
          <button id="passwordCancel" class="dialogButton "><span data-l10n-id="password_cancel">Cancel</span></button>
          <button id="passwordSubmit" class="dialogButton"><span data-l10n-id="password_ok">Öffnen</span></button>
        </div>
      </dialog>
